            ...
            if ($invoices[$cid] == 0 || $doctypes[$cid] != $assign['invoice'] || $paytypes[$cid] != $inv_paytype
                ...
                $DB->Execute(
                    ...
                    array(
                        ...
                        empty($assign['post_address_id']) ?: $LMS->CopyAddress($assign['post_address_id']),
                        $currency,
                        $currencyvalues[$currency],
                        empty($customer['documentmemo']) ?: $customer['documentmemo'],
                    ...
                    if ($assign['invoice'] == DOC_DNOTE) {
                        ...
                        $DB->Execute(
                            ...
                            array(
                                ...
                                $assign['count'],
                                $desc,
                                empty($assign['tariffid']) ?: $assign['tariffid'],
                                $itemid,
                                $assign['pdiscount'],
                                $assign['vdiscount'],
                                $assign['period'],
