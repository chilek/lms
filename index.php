...
if(version_compare('2.6.0', $SMARTY->_version) > 0)
	die('<B>Old version of Smarty engine! You must get newest from <A HREF="http://www.smarty.net/distributions/Smarty-2.6.8.tar.gz">http://www.smarty.net/distributions/Smarty-2.6.8.tar.gz</A></B>');
