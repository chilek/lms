...
if (!is_readable($CONFIG_FILE)) {
    ...
    $CONFIG['directories']['lib_dir'] = (!isset($CONFIG['directories']['lib_dir']) ? $CONFIG['directories']['sys_dir'] . DIRECTORY_SEPARATOR . 'lib' : $CONFIG[
'directories']['lib_dir']);
            ...
            if (count($attachments)!=0  and !empty($uid)) {
                foreach ($attachments as $at) {
                    if ($at[is_attachment]==1  && ConfigHelper::getConfig('rt.mail_dir')) {
                        ...
                        VALUES (?,?,?)', array($message['id'], $at[filename], $at[contenttype]));
