...
elseif (isset($_POST['customerdata']))
{
	...
	if ($customerdata['ten'] !='') {
		...
		if (ConfigHelper::checkConfig('phpui.customer_ten_existence_check') && !isset($customerdata['tenexistencewarning'])
	...
	if ($customerdata['ssn'] != '') {
		...
		if (ConfigHelper::checkConfig('phpui.customer_ssn_existence_check') && !isset($customerdata['ssnexistencewarning'])
