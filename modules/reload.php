...
switch($_RELOAD_TYPE)
{
	...
	case "lmsd-tcp":
		...
		if($r_session=="+OK"&&$r_auth=="+OK")
			echo "Autoryzacja siê powiod³a.<br>";
		else
			echo "Autoryzacja siê nie powiod³a.<br>";
		if($r_dhcp=="+OK")
