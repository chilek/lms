...
function refresh($params)
{
	...
	switch ($type) {
		case 2:
			if (empty(ConfigHelper::getConfig('phpui.arping_helper')))
				$cmd = 'arping %i -c 1 -w 1.0';
			else
				$cmd = ConfigHelper::getConfig('phpui.arping_helper');
		...
		case 1:
        default:
			if (empty(ConfigHelper::getConfig('phpui.ping_helper')))
				$cmd = 'ping %i -c 1 -s 1450 -w 1.0';
			else
				$cmd = ConfigHelper::getConfig('phpui.ping_helper');
