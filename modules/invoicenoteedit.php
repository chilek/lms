...
switch ($action) {
	...
	case 'setheader':
		...
		if ($cnote['cdate']) {
			...
			$day = date('d', $cnote['cdate']);
                        $month = date('m', $cnote['cdate']);
                        $year = date('Y', $cnote['cdate']);
                        $oldday = date('d', $cnote['oldcdate']);
                        $oldmonth = date('m', $cnote['oldcdate']);
                        $oldyear = date('Y', $cnote['oldcdate']);
