<?php
/*
 * OKBANK.PL parser wyciagow w formacie XML
 */
...
{
    $upload_dir = '/usr/local/www/lms.alfa-system.pl/wyciagi/';
...
$filename='/usr/local/www/lms.alfa-system.pl/wyciagi/index.html';
if (!is_writable($filename)) {
    echo "<h1>The file in $filename is not writable!</h1>";
}
...
$SMARTY->display('cashimport_xml.html');
