	...
	case 'customerlist':
		...
		switch($_POST['filter'])
		{
			case 0:
				...
				$SMARTY->assign('customerlist', $LMS->GetCustomerList($_POST['order'].','.$_POST['direction'], $_POST['filter'], $_POST['network'], $_POST['customergroup'], NULL, $date, 'AND', $_POST['nodegroup']));
			break;
			case 1:
