...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_getNodeLocks=function(){return xajax.request({xjxfun:'getNodeLocks'},{parameters:arguments});};xajax_addNodeLock=function(){return xajax.request({xjxfun:'addNodeLock'},{parameters:arguments});};xajax_delNodeLock=function(){return xajax.request({xjxfun:'delNodeLock'},{parameters:arguments});};xajax_getThroughput=function(){return xajax.request({xjxfun:'getThroughput'},{parameters:arguments});};xajax_getNodeStats=function(){return xajax.request({xjxfun:'getNodeStats'},{parameters:arguments});};xajax_getManagementUrls=function(){return xajax.request({xjxfun:'getManagementUrls'},{parameters:arguments});};xajax_addManagementUrl=function(){return xajax.request({xjxfun:'addManagementUrl'},{parameters:arguments});};xajax_delManagementUrl=function(){return xajax.request({xjxfun:'delManagementUrl'},{parameters:arguments});};xajax_updateManagementUrl=function(){return xajax.request({xjxfun:'updateManagementUrl'},{parameters:arguments});};xajax_getRadioSectors=function(){return xajax.request({xjxfun:'getRadioSectors'},{parameters:arguments});};xajax_getFirstFreeAddress=function(){return xajax.request({xjxfun:'getFirstFreeAddress'},{parameters:arguments});};