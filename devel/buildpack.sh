...
cd lms/lib
wget http://smarty.php.net/distributions/Smarty-2.6.16.tar.gz
tar -xzf Smarty-2.6.16.tar.gz
mv Smarty-2.6.16/libs Smarty
rm -Rf Smarty-2.6.16 Smarty-2.6.16.tar.gz
cd ../
rm -Rf $NOTDISTRIB
cd ../
