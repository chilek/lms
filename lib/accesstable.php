...
$access['table'][3]['allow_reg']	= '^((tariff)(add|info|list|move|edit|delete)|(payment)(add|del|edit|info|list)|(balance|customerbalance)(new|add|ok|del|list)|(cashreg(list|add|edit|del|info))|(invoice|invoice(list|new|edit|note|report|paid))|number|export|print|cashimport|cashimportparser)$';
...
$access['table'][5]['allow_reg']	= '^((customer|document)(add|edit|info|infoshort|list|del|print|assignments|assignmentsedit|search|warn)|documentgen|nodewarn|choosenode|customergroup(add|edit|del|info|list|move))$';
...
$access['table'][10]['allow_reg']   	= '^(rtsearch|rtqueue(list|info|view)|(rtticket|rtmessage|note)(add|edit|info|view|del|print))$';
...
$access['table'][16]['allow_reg']   	= '^(cashreglist|receipt|receipt(list|edit|add|del|adv)|choosecustomer)$';
