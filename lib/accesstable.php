...
$access['table'][3]['allow_reg']	= '^((tariff)(add|info|list|move|edit|delete)|(payment)(add|del|edit|info|list)|(balance|userbalance)(new|add|ok|del|list)|(invoice|invoice(list|new|edit|report|paid))|prepayments|choosecovenants|cashimport|cashimportparser)$';
...
if(isset($_CONFIG['phpui']['custom_accesstable']))
	@include_once($_LIB_DIR.'/'.$_CONFIG['phpui']['custom_accesstable']);
