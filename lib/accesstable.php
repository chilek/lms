...
$access['table'][3]['allow_reg']	= '^((tariff)(add|info|list|move|edit|delete)|(payment)(add|del|edit|info|list)|(balance|customerbalance)(new|add|ok|del|list)|(taxrate)(list|add|edit|del))|(receipt|receipt(list|add|edit|del))|(invoice|invoice(list|new|edit|report|paid))|prepayments|choosecovenants|number)$';
