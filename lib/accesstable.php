...
$access_table = array(
	...
	'read_only' => array(
		...
		'allow_regexp' => '^(([a-z]+(list|info|view|search|balance|infoshort))|customeraddresses|customerdevices|netdevmap|eventprint|eventnote|nodelistshort|number|choose[a-z]+)$',
	),
	...
	'customer_management' => array(
		...
		'allow_regexp' => '^((customer|document)(add|edit|info|infoshort|list|del|print|search|warn|cutoffstop|group)|customeraddresses|customerdevices|documentgen|documentview|nodewarn|choosenode)$',
	),
