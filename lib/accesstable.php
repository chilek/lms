...
$access['table'][5]['allow_reg']	= '^((customer|document)(add|edit|info|infoshort|list|del|print|assignments|assignmentsedit|search|warn)|documentgen|nodewarn|customergroup(add|edit|del|info|list|move))$';
