...
class LMSTcpdfInvoice extends LMSInvoice {
	...
	public function invoice_qr2pay_code() {
		$x = $this->backend->GetX();
		$y = $this->backend->GetY();
		$this->backend->writeHTMLCell(150, 0, '', '', trans("&nbsp; <BR> Scan and Pay <BR> You can make a transfer simply and quickly using your phone. <BR> To make a transfer, please scan with a QRcode in your smartphone in your bank's application."), 0, 1, 0, true, 'R');
