...
$this->Execute("UPDATE addresses SET city = NULL WHERE city IS NOT NULL AND char_length(city) = 0");
$this->Execute("UPDATE addresses SET street = NULL WHERE street IS NOT NULL AND char_length(street) = 0");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2017031500', 'dbversion'));
