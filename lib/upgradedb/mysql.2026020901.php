...
$this->Execute("ALTER TABLE users MODIFY COLUMN lastloginip varchar(40) NOT NULL DEFAULT ''");
$this->Execute("ALTER TABLE users MODIFY COLUMN failedloginip varchar(40) NOT NULL DEFAULT ''");
...
$this->Execute("ALTER TABLE up_customers MODIFY COLUMN lastloginip varchar(40) NOT NULL DEFAULT ''");
$this->Execute("ALTER TABLE up_customers MODIFY COLUMN failedloginip varchar(40) NOT NULL DEFAULT ''");
