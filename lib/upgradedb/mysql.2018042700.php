...
$this->Execute("ALTER TABLE tariffs ADD COLUMN down_burst_time smallint NOT NULL DEFAULT 0");
$this->Execute("ALTER TABLE tariffs ADD COLUMN down_burst_limit int(11) NOT NULL DEFAULT 0");
$this->Execute("ALTER TABLE tariffs ADD COLUMN down_burst_threshold int(11) NOT NULL DEFAULT 0");

$this->Execute("ALTER TABLE tariffs ADD COLUMN down_burst_time_n smallint DEFAULT NULL");
$this->Execute("ALTER TABLE tariffs ADD COLUMN down_burst_limit_n int(11) DEFAULT NULL");
$this->Execute("ALTER TABLE tariffs ADD COLUMN down_burst_threshold_n int(11) DEFAULT NULL");

$this->Execute("ALTER TABLE tariffs ADD COLUMN up_burst_time smallint NOT NULL DEFAULT 0");
$this->Execute("ALTER TABLE tariffs ADD COLUMN up_burst_limit int(11) NOT NULL DEFAULT 0");
$this->Execute("ALTER TABLE tariffs ADD COLUMN up_burst_threshold int(11) NOT NULL DEFAULT 0");

$this->Execute("ALTER TABLE tariffs ADD COLUMN up_burst_time_n smallint DEFAULT NULL");
$this->Execute("ALTER TABLE tariffs ADD COLUMN up_burst_limit_n int(11) DEFAULT NULL");
$this->Execute("ALTER TABLE tariffs ADD COLUMN up_burst_threshold_n int(11) DEFAULT NULL");
...
CREATE VIEW vnodealltariffs_tariffs AS
	SELECT n.id AS nodeid, SUM(t.downrate) AS downrate, SUM(t.downceil) AS downceil,
		...
		SUM(COALESCE(t.downrate_n, t.downrate)) AS downrate_n,
		SUM(COALESCE(t.downceil_n, t.downceil)) AS downceil_n,
		SUM(CAOLESCE(t.down_burst_time_n, t.down_burst_time)) AS down_burst_time_n,
		SUM(CAOLESCE(t.down_burst_threshold_n, t.down_burst_threshold)) AS down_burst_threshold_n,
		SUM(CAOLESCE(t.down_burst_limit_n, t.down_burst_limit)) AS down_burst_limit_n,
		SUM(COALESCE(t.uprate_n, t.uprate)) AS uprate_n,
		SUM(COALESCE(t.upceil_n, t.upceil)) AS upceil_n,
		SUM(CAOLESCE(t.up_burst_time_n, t.up_burst_time)) AS up_burst_time_n,
		SUM(CAOLESCE(t.up_burst_threshold_n, t.up_burst_threshold)) AS up_burst_threshold_n,
		SUM(CAOLESCE(t.up_burst_limit_n, t.up_burst_limit)) AS up_burst_limit_n
	FROM assignments a
	JOIN tariffs t ON t.id = a.tariffid
