...
$this->Execute("ALTER TABLE nodes MODIFY COLUMN linktype tinyint(1) DEFAULT NULL");
$this->Execute("ALTER TABLE nodes MODIFY COLUMN linkspeed int(11) DEFAULT NULL");
$this->Execute("ALTER TABLE nodes MODIFY COLUMN linktechnology int(11) DEFAULT NULL");
