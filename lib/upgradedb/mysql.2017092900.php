...
$this->Execute("DELETE FROM receiptcontents WHERE NOT EXISTS (SELECT null FROM documents d WHERE receiptcontents.docid = d.id)");
...
$this->Execute("DELETE FROM invoicecontents WHERE NOT EXISTS (SELECT null FROM documents d WHERE invoicecontents.docid = d.id)");
