...
if (!$this->ResourceExists('ksefinvoices.from_date', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("
        ALTER TABLE ksefinvoices ADD COLUMN from_date bigint;
        UPDATE ksefinvoices SET from_date = issue_date;
        ALTER TABLE ksefinvoices ALTER COLUMN from_date SET NOT NULL
    ");
}

if (!$this->ResourceExists('ksefinvoices.to_date', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("ALTER TABLE ksefinvoices ADD COLUMN to_date bigint DEFAULT NULL");
}
