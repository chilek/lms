...
if ($this->ResourceExists('customers.creationdate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE customers ALTER COLUMN creationdate TYPE bigint");
}

if ($this->ResourceExists('customers.moddate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE customers ALTER COLUMN moddate TYPE bigint");
}

if ($this->ResourceExists('customers.pinlastchange.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE customers ALTER COLUMN pinlastchange TYPE bigint");
}

if ($this->ResourceExists('customers.cutoffstop.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE customers ALTER COLUMN cutoffstop TYPE bigint");
}
...
if ($this->ResourceExists('documents.cdate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE documents ALTER COLUMN cdate TYPE bigint");
}

if ($this->ResourceExists('documents.sdate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE documents ALTER COLUMN sdate TYPE bigint");
}

if ($this->ResourceExists('documents.adate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE documents ALTER COLUMN adate TYPE bigint");
}

if ($this->ResourceExists('documents.senddate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE documents ALTER COLUMN senddate TYPE bigint");
}

if ($this->ResourceExists('documents.confirmdate.int4', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE documents ALTER COLUMN confirmdate TYPE bigint");
}
