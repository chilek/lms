...
if (!$this->ResourceExists('ksefinvoices.bank_name', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("ALTER TABLE ksefinvoices ADD COLUMN bank_name varchar(100) DEFAULT NULL");
}
if (!$this->ResourceExists('ksefinvoices.pay_date', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("ALTER TABLE ksefinvoices ADD COLUMN pay_date bigint DEFAULT NULL");
}
