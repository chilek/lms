...
$this->Execute("ALTER TABLE customers ADD COLUMN ict smallint NOT NULL DEFAULT 0");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2021010700', 'dbversion'));
