...
if (!$this->ResourceExists('divisions.serviceemail', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("DROP VIEW vdivisions");

    $this->Execute("ALTER TABLE divisions ADD COLUMN serviceemail varchar(255) DEFAULT NULL");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2026081100', 'dbversion'));
