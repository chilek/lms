...
$this->Execute("
	ALTER TABLE customers ALTER COLUMN ten TYPE varchar(50);
	ALTER TABLE customers ALTER COLUMN ssn TYPE varchar(50);
	ALTER TABLE divisions ALTER COLUMN ten TYPE varchar(50);
	ALTER TABLE documents ALTER COLUMN ten TYPE varchar(50);
	ALTER TABLE documents ALTER COLUMN ssn TYPE varchar(50)
");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2018082100', 'dbversion'));
