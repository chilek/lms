...
$this->Execute("ALTER TABLE ksefinvoiceitems MODIFY COLUMN net_price numeric(24,8) NOT NULL");
$this->Execute("ALTER TABLE ksefinvoiceitems MODIFY COLUMN net_value numeric(16,2) NOT NULL");
