...
if (!$this->ResourceExists('assignments.recipient_address_id2', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("
        ALTER TABLE assignments ADD COLUMN recipient_address_id2 integer DEFAULT NULL;
        ALTER TABLE assignments ADD CONSTRAINT assignments_recipient_address_id2_fkey
...
if (!$this->ResourceExists('documents.recipient_address_id2', LMSDB::RESOURCE_TYPE_COLUMN)) {
    $this->Execute("
        ALTER TABLE documents ADD COLUMN recipient_address_id2 integer DEFAULT NULL;
        ALTER TABLE documents ADD CONSTRAINT documents_recipient_address_id2_fkey
            FOREIGN KEY (recipient_address_id2) REFERENCES addresses (id) ON DELETE SET NULL ON UPDATE CASCADE
    ");
}
