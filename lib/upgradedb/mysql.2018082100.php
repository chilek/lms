...
$this->Execute("ALTER TABLE divisions MODIFY COLUMN ten varchar(50)");
$this->Execute("ALTER TABLE documents MODIFY COLUMN ten varchar(50)");
$this->Execute("ALTER TABLE documents MODIFY COLUMN ssn varchar(50)");
