...
$this->Execute("ALTER TABLE customers DROP COLUMN consentdate");
$this->Execute("ALTER TABLE customers DROP COLUMN einvoice");
$this->Execute("ALTER TABLE customers DROP COLUMN mailingnotice");
$this->Execute("ALTER TABLE customers DROP COLUMN invoicenotice");
