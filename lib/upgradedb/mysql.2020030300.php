...
$this->Execute("ALTER TABLE customers ADD COLUMN documentmemo TEXT DEFAULT NULL");
$this->Execute("ALTER TABLE documents ADD COLUMN memo TEXT DEFAULT NULL");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2020030300', 'dbversion'));
