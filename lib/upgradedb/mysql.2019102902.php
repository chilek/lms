...
$this->Execute("ALTER TABLE divisions ADD COLUMN bank varchar(100) DEFAULT NULL");
$this->Execute("
...
");
$this->Execute("ALTER TABLE documents ADD COLUMN div_bank varchar(100) DEFAULT NULL");
