...
if ($this->ResourceExists('assignments.at.int(11)', LMSDB::RESOURCE_TYPE_COLUMN_TYPE)) {
    $this->Execute("ALTER TABLE assignments MODIFY COLUMN at int(16) NOT NULL DEFAULT 0");
}
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2025021300', 'dbversion'));
