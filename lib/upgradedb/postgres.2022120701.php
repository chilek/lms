...
$this->Execute("ALTER TABLE nodes ALTER COLUMN linktype DROP NOT NULL");
$this->Execute("ALTER TABLE nodes ALTER COLUMN linktype SET DEFAULT NULL");

$this->Execute("ALTER TABLE nodes ALTER COLUMN linkspeed DROP NOT NULL");
$this->Execute("ALTER TABLE nodes ALTER COLUMN linkspeed SET DEFAULT NULL");

$this->Execute("ALTER TABLE nodes ALTER COLUMN linktechnology DROP NOT NULL");
$this->Execute("ALTER TABLE nodes ALTER COLUMN linktechnology SET DEFAULT NULL");
