...
if (!$this->ResourceExists('suspensions', LMSDB::RESOURCE_TYPE_TABLE)) {
    $this->Execute("CREATE SEQUENCE suspensions_id_seq");
    $this->Execute(
...
if (!$this->ResourceExists('assignmentsuspensions', LMSDB::RESOURCE_TYPE_TABLE)) {
    $this->Execute("CREATE SEQUENCE assignmentsuspensions_id_seq");
    $this->Execute(
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2024042700', 'dbversion'));
