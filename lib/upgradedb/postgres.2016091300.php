...
$this->Execute("ALTER TABLE networks ADD COLUMN authtype smallint DEFAULT 0 NOT NULL");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2016091300', 'dbversion'));
