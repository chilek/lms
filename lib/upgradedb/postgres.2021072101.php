...
define('DOC_FLAG_NET_ACCOUNT_2021072101', 16);
...
$this->Execute(
    ...
    array(
        DOC_FLAG_NET_ACCOUNT_2021072101,
        DOC_FLAG_NET_ACCOUNT_2021072101,
        DOC_FLAG_NET_ACCOUNT_2021072101,
        DOC_FLAG_NET_ACCOUNT_2021072101,
        DOC_FLAG_NET_ACCOUNT_2021072101,
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2021072101', 'dbversion'));
