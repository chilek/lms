...
$this->Execute("ALTER TABLE customers ADD COLUMN icexpires int(11) DEFAULT NULL");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2021072900', 'dbversion'));
