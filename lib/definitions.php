...
$ACCOUNTTYPES = array(
	ACCOUNT_SHELL => array(
		...
		'accountquotalimittip' => trans('Enter quota limit of shell account'),
		'accountlimitlabel' => trans('Limit of shell accounts:'),
		'accountquotalimitlabel' => trans('Quota limit of shell account:'),
	),
	ACCOUNT_MAIL => array(
		'label' => trans('mail'),
		'alias' => 'mail',
		'accountlimittip' => trans('Enter limit of e-mail accounts'),
		'accountquotalimittip' => trans('Enter quota limit of e-mail account'),
		'accountlimitlabel' => trans('Limit of e-mail accounts:'),
		'accountquotalimitlabel' => trans('Quota limit of e-mail account:'),
	),
	ACCOUNT_WWW => array(
		'label' => trans('www'),
		'alias' => 'www',
		'accountlimittip' => trans('Enter limit of www accounts'),
		'accountquotalimittip' => trans('Enter quota limit of www account'),
		'accountlimitlabel' => trans('Limit of www accounts:'),
		'accountquotalimitlabel' => trans('Quota limit of www account:'),
	),
	ACCOUNT_FTP => array(
		'label' => trans('ftp'),
		'alias' => 'ftp',
		'accountlimittip' => trans('Enter limit of ftp accounts'),
		'accountquotalimittip' => trans('Enter quota limit of ftp account'),
		'accountlimitlabel' => trans('Limit of ftp accounts:'),
		'accountquotalimitlabel' => trans('Quota limit of ftp account:'),
	),
	ACCOUNT_SQL => array(
		'label' => trans('sql'),
		'alias' => 'sql',
		'accountlimittip' => trans('Enter limit of sql accounts'),
		'accountquotalimittip' => trans('Enter quota limit of sql account'),
		'accountlimitlabel' => trans('Limit of sql accounts:'),
		'accountquotalimitlabel' => trans('Quota limit of sql account:'),
	),
	ACCOUNT_CLOUD => array(
		'label' => trans('cloud'),
		'alias' => 'cloud',
		'accountlimittip' => trans('Enter limit of cloud accounts'),
		'accountquotalimittip' => trans('Enter quota limit of cloud account'),
		'accountlimitlabel' => trans('Limit of cloud accounts:'),
		'accountquotalimitlabel' => trans('Quota limit of cloud account:'),
	),
);
