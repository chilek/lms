...
class LMSDivisionManager extends LMSManager implements LMSDivisionManagerInterface
{
    ...
    public function AddDivision($division)
    {
        ...
        $args = array(
            ...
            'label'           => empty($division['label']) ?: $division['label'],
            'firstname'       => empty($division['firstname']) || empty($division['lastname']) || empty($division['birthdate']) ?: $division['firstname'],
            'lastname'        => empty($division['firstname']) || empty($division['lastname']) || empty($division['birthdate']) ?: $division['lastname'],
            'birthdate'       => empty($division['firstname']) || empty($division['lastname']) || empty($division['birthdate']) ?: $division['birthdate'],
            'ten'             => $division['ten'],
            'regon'           => $division['regon'],
            'rbe'             => $division['rbe'],
            'rbename'         => $division['rbename'] ? $division['rbename'] : '',
            'telecomnumber'   => $division['telecomnumber'] ? $division['telecomnumber'] : '',
            'bank'            => empty($division['bank']) ?: $division['bank'],
            ...
            'email'           => empty($division['email']) ?: $division['email'],
            'phone'           => empty($division['phone']) ?: $division['phone'],
