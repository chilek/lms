...
$_LANG['Enter customer ID, first/lastname, phone, email address and press Enter'] = 'Wprowadź identyfikator klienta, imię, nazwisko, adres email, numer telefonu i naciśnij Enter';
...
$_LANG['Default invoices paytype. Default: "CASH"'] = 'Domyślny typ płatności. Domyślnie: "CASH"';
$_LANG['Integer value required!'] = 'Wymagana liczba całkowita!';
$_LANG['Invoice\'s paytype is required!'] = 'Typ płatności faktury jest wymagany!';
