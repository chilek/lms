...
$_LANG['Enabling this option will reset numbering of documents at beginning of every month.'] = 'Włączenie tej opcji zresetuje numerację dokumentów na początku każdego miesiąca.';
$_LANG['End:'] = 'Koniec:';
...
$_LANG['Enter accounting date in \'YYYY/MM/DD\' format (empty field means current date)'] = 'Wprowadź datę naliczania w formacie \'RRRR/MM/DD\' (puste pole oznacza datę dzisiejszą)';
...
$_LANG['Document number template. Default: number/LMS/year, ie. %N/LMS/%Y. Allowed variables: %N - successive number in year, %M - drow-up month, %Y - drow-up year.'] = 'Format numerowania dokumentów. Domyślnie: numer/LMS/rok, np. %N/LMS/%Y. Dostępne zmienne: %N - kolejny numer w roku, %M - miesiąc wystawienia, %Y - rok wystawienia.';
...
$_LANG['Last 10 customer unpaid covenants:'] = '10 Ostatnich nierozliczonych obciążeń klienta';
...
$_LANG['No such covenants in selected time period.'] = 'Brak obciążeń w wybranym okresie.';
...
$_LANG['Warning! This is example template of contract. You can edit contract.html file in templates directory or create your own and set contract_template option in [phpui] section of lms.ini file.'] = 'Uwaga to jest przykładowy wzór umowy. Możesz edytować plik contract.html w katalogu templates lub stworzyć własną i ustawić opcję contract_template w sekcji [phpui] pliku lms.ini.';
...
$_LANG['Document type is required!'] = 'Type dokumentu jest wymagany!';
$_LANG['Enter document number'] = 'Wprowadź numer dokumentu';
...
$_LANG['Numbering Plans List'] = 'Lista plan�w numeracji';
?>
