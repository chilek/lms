...
$_LANG['Are you sure, you want to remove this tag?'] = 'Jesteś pewien, że chcesz usunąć ten tag?';
$_LANG['Tariffs assigned to tag'] = 'Taryfy przypisane do tagu';
$_LANG['Tariffs not assigned to tag'] = 'Taryfy nieprzypisane do tagu';
$_LANG['This tag has not got any assigned tariffs.'] = 'Ten tag nie ma żadnych przypisanych taryf.';
$_LANG['All tariffs are assigned to this tag.'] = 'Wszystkie taryfy są przypisane do tego tagu.';
$_LANG['Move tariffs to tag'] = 'Przenieś taryfy do tagu';
$_LANG['Select tag to which you want to move tariffs'] = 'Wybierz tag, do którego chcesz przenieść taryfy';
$_LANG['Are you sure, you want to move tariffs to selected tag?'] = 'Czy jesteś pewien, że chcesz przenieść taryfy do wybranego tagu?';
$_LANG['Tags list'] = 'Lista tagów';
$_LANG['New tag'] = 'Nowy tag';
$_LANG['Add tag'] = 'Dodaj tag';
$_LANG['Reset tags'] = 'Resetuj tagi';
$_LANG['There are no tags in database.'] = 'Nie ma tagów w bazie danych.';
$_LANG['Tag with assigned tariffs cannont be deleted!'] = 'Tag z przypisanymi taryfami nie może zostać usunięty!';
