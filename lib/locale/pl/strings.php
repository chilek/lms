...
$_LANG['Account with that login name already exists in domain!'] = 'Konto o podanej nazwie już istnieje w tej domenie!';
...
$_LANG['Alias with that login name already exists in domain!'] = 'Alias o podanej nazwie już istnieje w tej domenie!';
$_LANG['- all -'] = '- wszystkie -';
$_LANG['all'] = 'wszystkie';
$_LANG['All'] = 'Wszystkie';
...
$_LANG['Check this option to remove records older than one year'] = 'Zaznacz tą opcję żeby usunąć rekordy starsze niż rok';
$_LANG['Check this option to remove stats of deleted nodes'] = 'Zaznacz tą opcję żeby usunąć statystyki komputerów które nie istnieją w bazie danych';
...
$_LANG['Creating subscriptions...'] = 'Tworzenie taryf...';
...
$_LANG['deleted<!singular>'] = 'usunięty';
...
$_LANG['Invalid date format: $0.\\nAccepted format is \'YYYY/MM/DD hh:mm\'.'] = 'Błędny format daty: $0.\\nDozwolony format to  \'YYYY/MM/DD gg:mm\'.';
$_LANG['Invalid date format: $0.\\nNo day value can be found.'] = 'Błędny format daty: $0.\\nNie znaleziono numeru dnia miesiąca.';
...
$_LANG['Nodes: list, search, add'] = 'Komputery: lista, przeszukiwanie, dodawanie';
...
$_LANG['No customers matching search criteria.'] = 'Brak klientów spełniających zadane kryteria.';
$_LANG['No customers matching search criteria or list is empty.'] = 'Brak klientów pasujących do reguł filtrowania, lub lista jest pusta.';
$_LANG['No customers with such subscription.'] = 'Brak klientów z tą taryfą.';
$_LANG['No devices for connection.'] = 'Brak urządzeń do podłączenia.';
...
$_LANG['No events matching search criteria.'] = 'Brak zdarzeń spełniających warunki wyszukiwania.';
...
$_LANG['No nodes matching search criteria.'] = 'Brak komputerów spełniających warunki wyszukiwania.';
...
$_LANG['No tickets matching search criteria.'] = 'Brak zgłoszeń spełniających warunki szukania.';
$_LANG['No such transactions'] = 'Brak transakcji';
$_LANG['Note'] = 'Notatka';
$_LANG['Note:'] = 'Notatka:';
$_LANG['Notes:'] = 'Notatki:';
$_LANG['No transactions found in database.'] = 'Nie znaleziono żadnych transakcji w bazie danych.';
...
$_LANG['Period'] = 'Okres';
$_LANG['Period:'] = 'Okres:';
$_LANG['Allow nodes addition with duplicated MAC address (not checking if some computer have that MAC yet). Default: 0 (off).'] = 'Zezwolenie na dodawanie komputerów ze zduplikowanymi adresami MAC (LMS nie sprawdza czy inny komputer nie ma już przypisanego danego adresu MAC). Domyślnie: 0 (wyłączone).';
...
$_LANG['Time'] = 'Czas';
$_LANG['Time:'] = 'Czas:';
$_LANG['WWW session timeout. After this time (in seconds) user will be logged out if action has been made. Default: 600.'] = 'Czas wygaśnięcia sesji. Po tym czasie (określonym w sekundach) użytkownik zostanie wylogowany jeżeli nie podejmie żadnej akcji. Domyślnie: 600.';
...
$_LANG['User with specified login exists or this login was used in the past!'] = 'Użytkownik o podanym loginie istnieje lub login ten był wykorzystany w przeszłości!';
$_LANG['value'] = 'wartość';
$_LANG['Value'] = 'Wartość';
$_LANG['Value:'] = 'Wartość:';
