...
$_LANG['Enter receipt number. WARNING! Changing this number can be DANGEROUS! (leave this field empty to obtain next number)'] = 'Wprowadź numer dowodu wpłaty. UWAGA! Zmiana tego numeru może być NIEBEZPIECZNA! (pozostaw to pole puste aby uzyskać kolejny numer)';
...
$_LANG['Enter customer ID, part of first/lastname, address, telephone, email, TEN, SSN or node name and press Enter.'] = 'Wprowadź ID klienta, część nazwiska/imienia, adresu, telefonu, emaila, NIPu, PESELa lub nazwy jego komputera i naciśnij Enter.';
