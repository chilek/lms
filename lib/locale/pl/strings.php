...
$_LANG['Enabling this option will reset numbering of invoices at beginning of every month.'] = 'Włączenie tej opcji zresetuje numerowanie faktur na początku każdego miesiąca.';
$_LANG['End:'] = 'Koniec:';
...
$_LANG['Invoice number template. Default: number/LMS/year, ie. %N/LMS/%Y. Allowed variables: %N - successive number in year, %M - drow-up month, %Y - drow-up year.'] = 'Format numerowania faktur. Domyślnie: numer/LMS/rok, np. %N/LMS/%Y. Dostępne zmienne: %N - kolejny numer w roku, %M - miesiąc wystawienia, %Y - rok wystawienia.';
...
$_LANG['Limit of records displayed on one page in customers list. Default: no limit.'] = 'Limit wyświetlanych rekordów na jednej stronie listy klientów. Domyślnie: brak limitu.';
