...
$_LANG['Template for user notice relevant to ticket in Helpdesk. %status - ticket status ; %cat - ticket categories ; %tid - ticket id ; %cid - customer id ; %subject - ticket subject ; %body - ticket body'] = 'Szablon tekstu dla powiadomień użytkowników o zgłoszeniach w Helpdesk. %status - status zgłoszenia ; %cat - kategorie zgłoszenia ; %tid - id zgłoszenia ; %cid - id klienta ; %subject - temat zgłoszenia ; %body - treść zgłoszenia';
$_LANG['Template for user notice relevant to ticket in Helpdesk. %status - ticket status ; %cat - ticket categories ; %tid - ticket id ; %cid - customer id ; %subject - ticket subject ; %body - ticket body ; %url - ticket url'] = 'Szablon tekstu dla powiadomień użytkowników o zgłoszeniach w Helpdesk. %status - status zgłoszenia ; %cat - kategorie zgłoszenia ; %tid - id zgłoszenia ; %cid - id klienta ; %subject - temat zgłoszenia ; %body - treść zgłoszenia ; %url - url zgłoszenia';
