...
$_LANG['Default Userpanel Rights:'] = 'Domyślne uprawnienia w Panelu klienta:';
...
$_LANG['Submit'] = 'Zapisz';
$_LANG['There are any userpanel rights.'] = 'Brak zdefiniowanych praw do Panelu klienta.';
...
$_LANG['Total:'] = 'Razem:';
$_LANG['Userpanel Configuration'] = 'Konfiguracja Panelu klienta';
$_LANG['Userpanel design style'] = 'Styl wyglądu Panelu klienta';
$_LANG['Userpanel hints style. Chose modern for animated assistant, classic for tips in LMS style, or none to disable hints displaying'] = 'Styl podpowiedzi w Panelu klienta. Wybierz nowoczesny, aby wyświetlać animowanego asystenta, klasyczny dla podpowiedzi w stylu LMS-a lub żaden, aby wyłączyć wyświetlanie podpowiedzi.';
$_LANG['Userpanel module <b>$a</b> not found!'] = 'Nie znaleziono modułu <b>$a</b>!';
$_LANG['Userpanel Rights:'] = 'Uprawnienia w Panelu klienta:';
$_LANG['Userpanel style:'] = 'Styl Panelu klienta:';
